...
class ShcherbackNeuralNetwork:
  ...
  *** ВАЖЛИВО ***:
  ...
  подальшому.
  Замість цього, прочитайте та запустіть його, щоб зрозуміти, як працює ця
  мережа.
  """
...
network = ShcherbackNeuralNetwork()
network.train(data, all_y_trues)

# Робимо передбачення
emily = np.array([-7, -3]) # 128 фунтів, 63 дюйми
frank = np.array([20, 2]) # 155 фунтів, 68 дюймів
